...
parser.add_argument('--base_model', type=str, required=False, default='i3d',
...
if args.base_model == 'c3d':
	...
	if args.mode == 'flow':
		...
		model.load_state_dict(torch.load('../i3d/models/flow_imagenet.pt'))
	else:
		model = InceptionI3d(400, in_channels=3)
		model.load_state_dict(torch.load('../i3d/models/rgb_imagenet.pt'))
